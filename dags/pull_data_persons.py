...
CSV_FILE_PATH = "output_dataset_persons.csv"
BUCKET_NAME = "dataengineerproject-448203-bucket1"
GCS_FILE_PATH ="crashes/persons.csv"
import pandas as pd
...
with DAG(
    ...
    extract_data_persons = PythonOperator(
    ...
    upload_py_file_to_gcs = LocalFilesystemToGCSOperator(
        ...
        src="./dags/persons_data_spark.py",  # Local CSV file
    ...
    extract_data_persons >> upload_to_gcs_task >> upload_py_file_to_gcs 
